/*
 * arch/arm/mach-tegra/board-enrc2u-sdhci.c
 *
...
static void *enrc2u_wifi_mem_prealloc(int section, unsigned long size)
{
...
int __init enrc2u_init_wifi_mem(void)
{
#ifdef CONFIG_DHD_USE_STATIC_BUF
	int i;
...
static int enrc2u_wifi_status_register(void (*callback)(int , void *), void *);

static int enrc2u_wifi_reset(int on);
/* HTC_WIFI_START */
//static int enrc2u_wifi_power(int on);
//static int enrc2u_wifi_set_carddetect(int val);
int enrc2u_wifi_power(int on);
int enrc2u_wifi_set_carddetect(int val);
int enrc2u_wifi_status(struct device *dev);
static int enrc2u_wifi_cd;		/* WIFI virtual 'card detect' status */
/* HTC_WIFI_END */

static struct wifi_platform_data enrc2u_wifi_control = {
	.set_power      = enrc2u_wifi_power,
	.set_reset      = enrc2u_wifi_reset,
	.set_carddetect = enrc2u_wifi_set_carddetect,
#ifdef CONFIG_DHD_USE_STATIC_BUF
	.mem_prealloc	= enrc2u_wifi_mem_prealloc,
#else
	.mem_prealloc	= NULL,
#endif
};
...
static struct platform_device enrc2u_wifi_device = {
	.name           = "bcmdhd_wlan",
	.id             = 1,
	.num_resources	= 1,
	.resource	= wifi_resource,
	.dev            = {
		.platform_data = &enrc2u_wifi_control,
	},
};
...
static struct tegra_sdhci_platform_data tegra_sdhci_platform_data0 = {
	.mmc_data = {
		.register_status_notify	= enrc2u_wifi_status_register,
...
static struct tegra_sdhci_platform_data tegra_sdhci_platform_data2 = {
	...
	.wp_gpio = -1,
	.power_gpio = -1,
	.suspend_gpiocfg = enrc2u_wifi_suspend_gpio,
	.resume_gpiocfg = enrc2u_wifi_resume_gpio,
};
...
static int enrc2u_wifi_status_register(
...
EXPORT_SYMBOL(enrc2u_wifi_set_carddetect);
...
/*	
	pr_debug("%s: %d\n", __func__, on);
	gpio_set_value(ENRC2U_WLAN_PWR, on);
	mdelay(100);
	gpio_set_value(ENRC2U_WLAN_RST, on);
	mdelay(200);

	return 0;
*/
}
EXPORT_SYMBOL(enrc2u_wifi_power);
/* HTC_WIFI_END */
...
int __init enrc2u_sdhci_init(void)
{
