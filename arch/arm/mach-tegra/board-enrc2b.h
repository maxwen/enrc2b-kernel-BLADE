/*
 * arch/arm/mach-tegra/board-enrc2b.h
 *
...
#ifndef _MACH_TEGRA_BOARD_ENRC2B_H
#define _MACH_TEGRA_BOARD_ENRC2B_H
...
int enrc2b_charge_init(void);
int enrc2b_sdhci_init(void);
int enrc2b_pinmux_init(void);
int enrc2b_panel_init(void);
int enrc2b_sensors_init(void);
int enrc2b_cam_init(void);
int touch_init(void);
int enrc2b_kbc_init(void);
int enrc2b_emc_init(void);
int enrc2b_regulator_init(void);
int enrc2b_suspend_init(void);
int enrc2b_edp_init(void);
void enrc2b_bpc_mgmt_init(void);
int enrc2b_audio_codec_init(struct htc_asoc_platform_data *);
...
/* BT */
#define ENRC2B_GPIO_BT_UART3_CTS      TEGRA_GPIO_PA1
#define ENRC2B_GPIO_BT_UART3_RTS      TEGRA_GPIO_PC0
#define ENRC2B_GPIO_BT_UART3_TX       TEGRA_GPIO_PW6
#define ENRC2B_GPIO_BT_UART3_RX       TEGRA_GPIO_PW7
#define ENRC2B_GPIO_BT_WAKE           TEGRA_GPIO_PD4
#define ENRC2B_GPIO_BT_SHUTDOWN_N     TEGRA_GPIO_PU0
#define ENRC2B_GPIO_BT_HOST_WAKE      TEGRA_GPIO_PO5
...
#endif /*_MACH_TEGRA_BOARD_ENRC2B_H */
