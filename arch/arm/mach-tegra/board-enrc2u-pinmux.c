/*
 * arch/arm/mach-tegra/board-enrc2u-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config enrc2u_drive_pinmux[] = {
...
int __init enrc2u_pinmux_init(void)
{
	 ...
	 */
	tegra_drive_pinmux_config_table(enrc2u_drive_pinmux,
					ARRAY_SIZE(enrc2u_drive_pinmux));
	return 0;
}
