...
//0801 DVFS table got from NV
static const struct tegra_emc_table evitareul_emc_tables_h5tc2g_evt_533[] =
{
	{
		0x32,       /* Rev 3.2 */
...
int evitareul_emc_init(void)
{
	struct board_info board_info;
		...
		tegra_init_emc(evitareul_emc_tables_h5tc2g_evt_533,
			       ARRAY_SIZE(evitareul_emc_tables_h5tc2g_evt_533));
