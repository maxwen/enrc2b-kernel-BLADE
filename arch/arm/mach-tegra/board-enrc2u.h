/*
 * arch/arm/mach-tegra/board-enrc2u.h
 *
...
#ifndef _MACH_TEGRA_BOARD_ENRC2U_H
#define _MACH_TEGRA_BOARD_ENRC2U_H
...
int enrc2u_charge_init(void);
int enrc2u_sdhci_init(void);
int enrc2u_pinmux_init(void);
int enrc2u_panel_init(void);
int enrc2u_sensors_init(void);
int enrc2u_cam_init(void);
int touch_init(void);
int enrc2u_kbc_init(void);
int enrc2u_emc_init(void);
int enrc2u_regulator_init(void);
int enrc2u_suspend_init(void);
int enrc2u_edp_init(void);
void enrc2u_bpc_mgmt_init(void);
int enrc2u_audio_codec_init(struct htc_asoc_platform_data *);
...
#define BB_GPIO_CWR                     TEGRA_GPIO_PS2
...
/* BT */
#define ENRC2U_GPIO_BT_UART3_CTS      TEGRA_GPIO_PA1
#define ENRC2U_GPIO_BT_UART3_RTS      TEGRA_GPIO_PC0
#define ENRC2U_GPIO_BT_UART3_TX       TEGRA_GPIO_PW6
#define ENRC2U_GPIO_BT_UART3_RX       TEGRA_GPIO_PW7
#define ENRC2U_GPIO_BT_WAKE           TEGRA_GPIO_PD4
#define ENRC2U_GPIO_BT_SHUTDOWN_N     TEGRA_GPIO_PU0
#define ENRC2U_GPIO_BT_HOST_WAKE      TEGRA_GPIO_PO5
...
#endif /*_MACH_TEGRA_BOARD_ENRC2U_H */
