...
struct diagchar_dev {
...
#if defined(CONFIG_DIAG_SDIO_PIPE) || defined(CONFIG_DIAG_HSIC_PIPE)
	...
	unsigned char *buf_poll_in_hsic;
	unsigned char *buf_poll_to_user;
	unsigned char *usb_buf_mdm_out;
	int pkt_size_to_user;
	...
	int hsic_suspend;
	int read_len_mdm;
	int hsic_pending_packets;
	int in_busy_hsic_read_on_device;
	int in_busy_hsic_write_on_device;
	int in_busy_hsic_poll_write_on_device;
