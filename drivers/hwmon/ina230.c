...
/* current resolution: 0.125mA */
#define currenta_register_to_ma(x) ((((x) * 5) >> 2) / 10)
...
EXPORT_SYMBOL_GPL(ina230_get_bus_voltage_multi);
...
EXPORT_SYMBOL_GPL(ina230_get_batt_voltage_current);
...
EXPORT_SYMBOL_GPL(ina230_get_batt_volt);
...
EXPORT_SYMBOL_GPL(ina230_get_batt_curr);
